...
//	@PostConstruct
	public void ad(){
		...
		skillset1.add("JAVA");
		skillset1.add("PHP");
		trainerDao.save(new Trainer("TR1002","Vishal",skillset1));
		...
		enrollmentDao.save(new Enrollment(new User(4,"",""),new TrainingProgram("TP101",null, null, null,null)));
		enrollmentDao.save(new Enrollment(new User(4,"",""),new TrainingProgram("TP102",null, null, null,null)));
		enrollmentDao.save(new Enrollment(new User(2,"",""),new TrainingProgram("TP101",null, null, null,null)));
		enrollmentDao.save(new Enrollment(new User(2,"",""),new TrainingProgram("TP102",null, null, null,null)));
		enrollmentDao.save(new Enrollment(new User(3,"",""),new TrainingProgram("TP101",null, null, null,null)));
